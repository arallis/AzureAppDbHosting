...
namespace AzureAppDbHosting.Controllers
{
    public class LeadEntitiesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,LeadDate,OwnerWalker,Name,Mobile,Email")] LeadEntity leadEntity)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,LeadDate,OwnerWalker,Name,Mobile,Email")] LeadEntity leadEntity)
        {
            if (id != leadEntity.Id)
            {
                return NotFound();
